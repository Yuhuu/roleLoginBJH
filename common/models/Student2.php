 ...
 */
class Student2 extends ActiveRecord {
...
//    }
    ...
    /**
     * this followed item still works when it is json
     */
    public function rules() {
//        return [
////            [['username', 'role_id', 'email'], 'required'],
//            [['role_id', 'user_type_id', 'status_id'], 'integer'],
